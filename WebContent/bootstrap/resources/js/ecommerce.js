...
*/
    ...
    if($('body').data('page') == 'products'){
        ...
        opt.oTableTools = {
            "sSwfPath": "copy_csv_xls_pdf.swf"/*tpa=http://themes-lab.com/pixit/admin/assets/js/assets/plugins/datatables/swf/copy_csv_xls_pdf.swf*/,
        ...
        var opt = {};
        opt.ajax = "http://themes-lab.com/pixit/admin/assets/js/assets/ajax/data-table.txt";

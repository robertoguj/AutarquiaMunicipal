d3 = function() {
  ...
  d3.behavior.drag = function() {
    ...
    function drag() {
      this.on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mousedown.drag", mousedown).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/touchstart.drag", mousedown);
    }
    function mousedown() {
      var target = this, event_ = event.of(target, arguments), eventTarget = d3.event.target, touchId = d3.event.touches ? d3.event.changedTouches[0].identifier : null, offset, origin_ = point(), moved = 0;
      var w = d3.select(d3_window).on(touchId != null ? "touchmove.drag-" + touchId : "http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mousemove.drag", dragmove).on(touchId != null ? "touchend.drag-" + touchId : "http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mouseup.drag", dragend, true);
      if (origin) {
      ...
      function dragend() {
        ...
        w.on(touchId != null ? "touchmove.drag-" + touchId : "http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mousemove.drag", null).on(touchId != null ? "touchend.drag-" + touchId : "http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mouseup.drag", null);
      }
    }
  ...
  d3.behavior.zoom = function() {
    ...
    function zoom() {
      this.on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mousedown.zoom", mousedown).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mousemove.zoom", mousemove).on(d3_behavior_zoomWheel + ".zoom", mousewheel).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/dblclick.zoom", dblclick).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/touchstart.zoom", touchstart).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/touchmove.zoom", touchmove).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/touchend.zoom", touchstart);
    }
    ...
    function mousedown() {
      var target = this, event_ = event.of(target, arguments), eventTarget = d3.event.target, moved = 0, w = d3.select(d3_window).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mousemove.zoom", mousemove).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mouseup.zoom", mouseup), l = location(d3.mouse(target));
      d3_window.focus();
      d3_eventCancel();
      function mousemove() {
        moved = 1;
      ...
      function mouseup() {
        ...
        w.on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mousemove.zoom", null).on("http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/mouseup.zoom", null);
        if (moved && d3.event.target === eventTarget) d3_eventSuppress(w, "http://themes-lab.com/pixit/admin/assets/plugins/charts-d3/click.zoom");
      }
    }
    function mousewheel() {
  ...
  var d3_category10 = [ "#3598DB", "#ff7f0e", "#2ca02c", "#C9625F", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf" ];
  var d3_category20 = [ "#3598DB", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#C9625F", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94", "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d", "#17becf", "#9edae5" ];

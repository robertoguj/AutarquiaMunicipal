...
function disableTextSelection(element) {
	element
		...
		.bind('http://themes-lab.com/pixit/admin/assets/plugins/fullcalendar/selectstart.ui', function() { return false; });
}
...
function enableTextSelection(element) {
	element
		...
		.css('MozUserSelect', '')
		.unbind('http://themes-lab.com/pixit/admin/assets/plugins/fullcalendar/selectstart.ui');
}
*/

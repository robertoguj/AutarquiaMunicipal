...
import divida.ativa.model.enu.TiposAmbientesAplicacao;
...
public final class ConfigApp {
    ...
    public static final String NOME_SISTEMA = "SISTEMA DE CONTROLE DE D?VIDAS ATIVAS";
	...
	public static final String CURRENT_PAGE_REPORT_TEMPLATE = "Total: {totalRecords} ({startRecord} At? {endRecord})";
    ...
    //Crio um m?todo est?tico que pode ser acessado por outras classes da aplicação sem a necessidade de instanciar

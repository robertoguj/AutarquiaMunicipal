...
import scda.model.Pessoa;
import scda.repository.Dividas;
import scda.service.DividaService;
	...
	*/
	...
	public String executarDivida() {
		...
		try {
			...
			MensagemUtil.addInfoMessage("Dívida executada com sucesso! ");
			
		} catch (Exception e) {
			MensagemUtil.addErrorMessage("Erro ao executar dívida! " + e.getMessage());
		}
